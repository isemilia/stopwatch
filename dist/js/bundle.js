...
/* harmony import */ var _stopwatch__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./stopwatch */ "./src/js/modules/stopwatch.js");
...
var Note = /*#__PURE__*/function () {
  function Note(time) {
    ...
    var parentSelector = arguments.length > 3 ? arguments[3] : undefined;
    var seconds = arguments.length > 4 ? arguments[4] : undefined;
...
function setNoteGaps() {
  noteItems.forEach(function (item, i) {
    if (i > 0) {
      var current = item.timeInSeconds;
      var prev = noteItems[i - 1].timeInSeconds;
      var gapInSeconds = Number(current) - Number(prev);
      var gap = (0,_stopwatch__WEBPACK_IMPORTED_MODULE_19__.split)(gapInSeconds);
      var gapFormatted = '';
      if (+gap.hours) {
        gapFormatted += "".concat(gap.hours, "h");
      }
      if (+gap.minutes) {
        gapFormatted += "".concat(gap.minutes, "m");
      }
      if (+gap.seconds) {
        gapFormatted += "".concat(gap.seconds, "s");
      }
...
function notes() {
  ...
  document.addEventListener('timerSplit', function (e) {
    var time = (0,_stopwatch__WEBPACK_IMPORTED_MODULE_19__.split)((0,_stopwatch__WEBPACK_IMPORTED_MODULE_19__.getSeconds)());
    var newNote = new Note(time, '', '', recordsParentSelector, (0,_stopwatch__WEBPACK_IMPORTED_MODULE_19__.getSeconds)());
...
function stopwatch(_ref) {
  var hoursSelector = _ref.hoursSelector,
    minutesSelector = _ref.minutesSelector,
    secondsSelector = _ref.secondsSelector,
    startTrigger = _ref.startTrigger,
    splitTrigger = _ref.splitTrigger,
  ...
  var startBtn = document.querySelector(startTrigger);
  ...
  var reset = function reset(interval) {
...
/*!**************************!*\
  ...
  \**************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_stopwatch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/stopwatch */ "./src/js/modules/stopwatch.js");
/* harmony import */ var _modules_notes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/notes */ "./src/js/modules/notes.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_notes__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
})();
